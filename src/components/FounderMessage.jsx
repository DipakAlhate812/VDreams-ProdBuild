  ...
  return (
    <div className="founder-message-container">
      ...
      <div className="message-content">
        ...
        <p>Most of India’s social issues—such as rapes, poverty, income inequality, caste discrimination, unemployment, corruption, inadequate healthcare, environmental concerns, mental health issues, rising suicides, and crime—are tied to the quality of education. Many of these challenges stem from individuals being literate rather than well-educated. Literacy alone cannot solve these issues; a deeper, more holistic education is needed.</p>
        ...
        <ul>
          ...
          <p>Note: This won't be traditional Edtech company focusing on specific courses and providing resources online. Although this will be small part of this journey.</p>
        </ul>
